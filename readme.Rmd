...
* <strong>Full Text API</strong>
	*   `ft_v2_api()` - retrieves descriptive data from V2 API see [this](https://asbcllc.com/blog/2017/august/intro_to_programming_with_gdeltr2/index.html) blog post for more on how to use this
